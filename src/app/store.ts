...
import { authReducer, LoginActionsType } from "../features/Login/auth-reduser";
...
type AppActionType = TasksActionsType | TodolistActionType | AppReducerType | LoginActionsType;
